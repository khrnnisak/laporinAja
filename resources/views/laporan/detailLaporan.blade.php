    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card border-primary">
          ...
          <div class="card-body">
            ...
            @endif
            <div class="col-auto">
              <a class="fa fa-arrow-left" type="button" href="{{ route('riwayatLaporan') }}"></a>
      ...
      <div class="col-md-4">
        ...
        <button class="btn btn-icon btn-3 btn-primary" type="button">
          <a href="{{ route('feedback', $fb->laporan_id) }}" class="nav-link text-white font-weight-bold px-0">
            <i class="fa fa-reply"></i>
            <span class="d-sm-inline d-none">Lihat Balasan</span>
          </a>
        </button>
        @endif
      </div>
